...
public class MaxBubble extends Service implements View.OnTouchListener, View.OnClickListener {
    ...
    public void onCreate() {
        ...
        mFloatingBubbleView = LayoutInflater.from(this).inflate(R.layout.activity_max_bubble, null);

        ImageView bubbleIcon = mFloatingBubbleView.findViewById(R.id.bubbleIconId);
    ...
    private void toggleWidget() {
        if (!isMinimized) {
            ...
            Intent intent;
            intent = new Intent(this, Bubble.class);
            stopService(new Intent(this,MaxBubble.class));
            startService(intent);
