...
import com.edubox.admin.common.PanelFrag;
...
public class DepartmentPanel extends BaseMenu implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_department_panel);
        ...
        if (savedInstanceState == null) {
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container, new PanelFrag()).commit();
