...
public class AddFaculty extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    private List<com.edubox.admin.std.student> studentList;
