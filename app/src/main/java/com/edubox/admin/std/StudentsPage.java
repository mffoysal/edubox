...
public class StudentsPage extends BaseMenu implements AdapterView.OnItemClickListener, ItemTouchListener, AllStudentsAdapter.OnEditClickListener, AllStudentsAdapter.OnDeleteClickListener {
...
//        dataList.add(androidData);
        ...
        adapter = new AllStudentsAdapter(getApplicationContext(), dataList,this, this, this);
...
//                        Log.e("UserFound","User FF Found");
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder instanceof AllStudentsAdapter.MyViewHolder3){
            String studentDelete = dataList.get(viewHolder.getAdapterPosition()).getStdName();
            student student = dataList.get(viewHolder.getAdapterPosition());
    ...
    public void onEditClick(student student) {
        Toast.makeText(this,"Edit Button is clicked "+student.getStdId(),Toast.LENGTH_SHORT).show();

    }

    @Override
    public void onDeleteClick(student student) {
        Toast.makeText(this,"Delete Button is clicked "+student.getStdId(),Toast.LENGTH_SHORT).show();
    }
}